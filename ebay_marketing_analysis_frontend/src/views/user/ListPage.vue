<template>
  ...
  <b-row>
    <b-col sm="12">
      ...
      <span class="px-2">
        <a class="btn btn-sm btn-icon btn-warning "  href="#" aria-label="Edit"  data-bs-original-title="Edit" data-bs-toggle="modal" data-bs-target="#userModal" >
                                    <span class="btn-inner" @click="getuserDetail(product)">                                       
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update/Edit User</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body gap-4 user-data-form">
        <input class="user-input" placeholder="Email" type="text" v-model="userdata.email" name="" id="">
        <input class="user-input" type="text" placeholder="Name" v-model="userdata.name" name="" id="">
        <input class="user-input" type="text" placeholder="Role" v-model="userdata.role" name="" id="">
        <input class="user-input" type="text" placeholder="phone Number" v-model="userdata.phone_number" name="" id="">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" @click="Updateuser(userdata)">Save changes</button>
      </div>
    </div>
  </div>
</div>
...
export default {
  ...
  setup() {
   ...
   try{
    ...
    try{
      const response = getUsersdata(data)
      if(response.ok)
      {
