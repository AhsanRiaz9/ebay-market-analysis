...
from .views import LoadProductConfiguration, DownloadEbayCondtions, DownloadEbayLocations, ConditionListView, ProductFiltersView, CategoriesView
...
urlpatterns = [
    ...
    path('product_filters/<int:category_id>/', ProductFiltersView.as_view()),
